        ...
        <>
            <div className='mobile:flex flex-col mobile:my-12 mx-2 laptop:flex-row justify-between laptop:my-32 mx-4 gap-10'>
                <div className='flex-col p-4 m-4 mobile:m-0 mobile:mt-5'>
                    ...
                    <Link to='/getInTouch'>
                    <button className='bg-blue-500 text-white text-2xl px-8 py-2 rounded-full hover:bg-white hover:text-blue-500 hover:border-2 hover:border-blue-500'>Get in touch NOW!</button>
                    </Link>
                </div>
